...
const Report = lazy(() =>
  import(/*webpackChunkName:'ReportPage'*/ "@/pages/Report")
);
      ...
      <AnimatePresence exitBeforeEnter initial={false}>
        <Switch location={location} key={location.pathname}>
          ...
          {(superadmin ||
            (permissions &&
              permissions.view &&
              permissions.view.includes("vendor"))) && (
          ...
          {(superadmin ||
            (permissions &&
              permissions.view &&
              permissions.view.includes("service"))) && (
            <PrivateRoute component={Product} path="/product" exact />
          )}
          {(superadmin ||
            (permissions &&
              permissions.view &&
              permissions.view.includes("admin"))) && (
